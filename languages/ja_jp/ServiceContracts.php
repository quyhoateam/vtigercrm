...
$languageStrings = array(
 // Basic Strings
	...
	'SINGLE_ServiceContracts' => 'サービス契約',
	'LBL_ADD_RECORD' => 'サービス契約の追加',
	'LBL_RECORDS_LIST' => 'サービス契約の一覧',
 // Blocks
	'LBL_SERVICE_CONTRACT_INFORMATION' => 'サービス契約の詳細',
 
 //Field Labels
	'Contract No' => '契約番号',
	'Start Date' => '開始日',
	'End Date' => '終了日',
	'Tracking Unit' => 'トラッキング単位',
	'Total Units' => '合計単位',
	'Used Units' => '使用済み単位',
	'Progress'=> '進捗',
	'Planned Duration' => '計画の期間 (日)',
	'Actual Duration' => '実際の期間 (日)',
);
