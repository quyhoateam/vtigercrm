...
/**
 * Class VTENotepad_Uninstall_View
 */
class VTENotepad_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_vtenotepad table
        echo "&nbsp;&nbsp;- Delete vtiger_vtenotepad table.";
        $result = $adb->pquery("DROP TABLE vtiger_vtenotepad");
